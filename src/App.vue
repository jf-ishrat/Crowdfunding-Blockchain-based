<template>
  <v-app class="grey lighten-3">
   <v-toolbar flat app dark class="blue">
      <v-toolbar-title class="headline text-uppercase purple--text">
      
        <span class="font-weight-bold">CROWDFUNDING</span>
      </v-toolbar-title>
    ...
    <v-content>
      <v-container>
         <v-parallax :src="require('@/assets/vbanner.png')">
           <v-layout column align-center justify-center>
           
           <span text-size="40pt" class="headline font-italic font-weight-bold mt-2 ml-4">Bring your project to life</span>
          </v-layout>
        </v-parallax>
      </v-container>
      ...
      <v-container>
        <v-layout row justify-center>
          <v-dialog v-model="startProjectDialog" max-width="800px" persistent>
                  ...
                  <v-layout wrap>
                    <v-flex xs12>
                      ...
                      <v-text-field
                        label="Project Title"
                        persistent-hint
                        v-model="newProject.title" prepend-icon="folder">
                      </v-text-field>
                    </v-flex>
                    <v-flex xs12>
                      <v-textarea
                        label="Description"
                        persistent-hint
                        v-model="newProject.description" prepend-icon="edit">
                      </v-textarea>
                    </v-flex>
                    <v-flex xs12 sm6 >
                      <v-text-field
      ...
      <v-container
        grid-list-lg
      >
        <h2 class="display-1 font-weight-semibold mb-1">
          Projects
        </h2>
        <v-layout row wrap>
